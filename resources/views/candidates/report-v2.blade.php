                     ...
                     <div class="text-base mb-6" style="line-height: 1.8;">
                        <div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 8px;">
                            ...
                            <span class="font-medium text-gray-800" style="display: inline-flex; align-items: center;">
                                ...
                                @if($isFullReport){{ $candidate->email }}@else<span style="color: #9ca3af; font-style: italic;">скрыто</span>@endif
                            </span>
                        </div>
                        <div style="display: flex; flex-wrap: wrap; align-items: center;">
                            <span class="font-medium text-gray-800" style="display: inline-flex; align-items: center; margin-right: 24px;">
                                ...
                                @if($isFullReport){{ $candidate->phone }}@else<span style="color: #9ca3af; font-style: italic;">скрыто</span>@endif
                            </span>
                            @if($candidate->instagram || !$isFullReport)
                                <span class="font-medium text-gray-800" style="display: inline-flex; align-items: center;">
                                    ...
                                    @if($isFullReport){{ $candidate->instagram }}@else<span style="color: #9ca3af; font-style: italic;">скрыто</span>@endif
                                </span>
                            @endif
                        </div>
                    </div>
                     ...
                     <div class="space-y-1">
                        <div class="flex items-start">
                         ...
                         <div class="flex data-row">
                             ...
                             <span class="text-base font-medium">@if($isFullReport){{ $candidate->marital_status ?: 'Не указано' }}@else<span style="color: #9ca3af; font-style: italic;">скрыто</span>@endif</span>
                         </div>
                         @php
                         ...
                         <div class="flex items-start">
                             ...
                             <span class="text-base font-medium flex-1">
                                 @if($isFullReport)
                                     ...
                                     @endif
                                 @else
                                     <span style="color: #9ca3af; font-style: italic;">скрыто</span>
                                 @endif
                             </span>
                         </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex data-row">
                        ...
                        <span class="text-base font-medium">@if($isFullReport){{ $candidate->religion ?: 'Не указано' }}@else<span style="color: #9ca3af; font-style: italic;">скрыто</span>@endif</span>
                    </div>
                    <div class="flex data-row">
                        <span class="w-60 text-base text-gray-600">Рел. практика:</span>
                        <span class="text-base font-medium">@if($isFullReport){{ $candidate->is_practicing ? 'Да' : 'Нет' }}@else<span style="color: #9ca3af; font-style: italic;">скрыто</span>@endif</span>
                    </div>
