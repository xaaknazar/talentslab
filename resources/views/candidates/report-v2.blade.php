                ...
                <div class="bg-gray-100 rounded-lg p-6">
                    ...
                    <div style="display: flex; align-items: flex-end; height: 180px; margin-bottom: 8px;">
                        ...
                        <div style="flex: 1; position: relative; height: 180px;">
                            ...
                            @endforeach
                            <div style="display: flex; align-items: flex-end; justify-content: center; height: 180px; gap: 4px; position: relative; z-index: 1;">
                                @foreach($row1Types as $type)
                                    ...
                                    @endphp
                                    <div style="width: 70px; height: {{ $barHeight }}px; background-color: {{ $config['color'] }}; border-radius: 6px 6px 0 0; display: flex; align-items: flex-start; justify-content: center; padding-top: {{ $barHeight > 35 ? '6' : '2' }}px;">
                    ...
                    <div style="display: flex; justify-content: center; gap: 4px; margin-left: 36px; margin-bottom: 24px;">
                        @foreach($row1Types as $type)
                            @php
                    ...
                    <div style="display: flex; justify-content: center; gap: 4px; margin-left: 36px;">
                        @foreach($row2Types as $type)
                            @php
                                $shortName = str_replace(' интеллект', '', $type);
                                $config = $intelligenceConfig[$type] ?? ['color' => '#cccccc', 'emoji' => '❓', 'img' => $twemojiBase . '2753.svg'];
