...
{{--                        <img src="data:image/png;base64,{{ base64_encode(file_get_contents($photoUrl)) }}" alt="{{ $labels['candidate_photo'] }}" class="w-47 h-69 object-cover rounded border-2 border-gray-300">--}}
        ...
        <div style="padding: 0 12px 12px 12px;">
            <!-- Опыт работы -->
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-800 mb-2">{{ $labels['work_experience'] }}</h2>
                    ...
                    @if($hasNewFields)
                            ...
                            @foreach($candidate->work_experience as $index => $experience)
                                <div style="padding: 8px 0;">
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 4px;">
                                        <div>
                                            <span class="text-base font-medium" style="color: #000000;">{{ mb_ucfirst($experience['position'] ?? $labels['not_specified']) }}</span>
                                            <span style="color: #000000; margin: 0 8px;">—</span>
                                            <span class="text-base font-medium" style="color: #000000;">{{ mb_ucfirst($experience['company'] ?? $labels['not_specified']) }}</span>
                        ...
                        <div style="margin-top: 16px;">
                            <div style="display: flex; align-items: center; margin-bottom: 4px;">
                                <span class="text-base" style="color: #374151; margin-right: 8px;">{{ $labels['total_experience'] }}:</span>
                                <span class="text-base font-medium" style="color: #111827;">{{ $candidate->total_experience_years ?? 0 }} {{ $labels['years'] }}</span>
                            </div>
                            <div style="display: flex; align-items: center;">
                                <span class="text-base" style="color: #374151; margin-right: 8px;">{{ $labels['job_satisfaction'] }}:</span>
                        ...
                        @if($candidate->awards && is_array($candidate->awards) && count(array_filter($candidate->awards)) > 0)
                            <div style="margin-top: 16px;">
                                <span class="text-lg font-bold" style="color: #000000; display: block; margin-bottom: 8px;">{{ $labels['awards_achievements'] }}</span>
