            ...
            <div class="main-card">
                ...
                <div class="right-panel">
                    ...
                    <p class="brand-description">
                        Talents Lab — современная онлайн-платформа с базой данных анкет, отражающих целостный психометрический портрет личности.
                        <br><br>
                        Пройдя анкетирование, вы сформируете анкету и сможете подобрать вакансию, максимально соответствующую вашим способностям и потенциалу.
                    </p>
                </div>
            </div>
        </div>
