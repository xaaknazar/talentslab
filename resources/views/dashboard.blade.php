                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                        ...
                        @if($candidate)
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('candidate.form', ['id' => $candidate->display_number]) }}" class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-600 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 disabled:opacity-25 transition">
                                    {{ __('Edit resume') }}
                                </a>
                                @if($candidate->step >= 5)
